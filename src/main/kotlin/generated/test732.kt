...
- mutexes 
*/
package org.example.generated.test732
...
fun main(): Unit= runBlocking {
    ...
    launch { processChannels(ch1, ch2, ch3, ch4, ch5) }
    launch { ch1.send(2) }
    launch { println("Channel 2 received: ${ch2.receive()}") }
    launch { println("Channel 4 processed: ${ch4.receive()}") }
    launch { ch5.send(7) }
}
