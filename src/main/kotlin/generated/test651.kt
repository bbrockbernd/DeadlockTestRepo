...
- mutexes 
*/
package org.example.generated.test651
...
fun conversion(channel: Channel<Int>, secondaryChannel: Channel<Int>) = GlobalScope.launch {
...
fun finalProcessing(channel: Channel<Int>) = GlobalScope.launch {
    for (i in channel) {
        process(i)
    }
}
