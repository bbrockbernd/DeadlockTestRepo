...
- mutexes 
*/
package org.example.generated.test622
...
class ChannelCoordinator {
    ...
    fun setup() {
        runBlocking {
            launch { sendToChannelA() }
            launch { receiveFromChannelA() }
            launch { sendToChannelB() }
            launch { receiveFromChannelC() }
            launch { sendAndReceiveChannelE() }
        }
    }
