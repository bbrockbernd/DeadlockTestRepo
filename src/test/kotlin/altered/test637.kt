...
import org.example.altered.test637.RunChecker637.Companion.pool
...
fun functionA(producer: Producer) = runBlocking(pool) {
    producer.produceValues()
}

fun functionB(consumer: Consumer) = runBlocking(pool) {
