...
import org.example.altered.test707.RunChecker707.Companion.pool
...
fun main(): Unit= runBlocking(pool) {
    ...
    launch(pool) { coroutine1(ch1, ch2, ch3) }
    launch(pool) { coroutine2(ch1, ch2, ch4) }
    launch(pool) { deadlockCoroutine(ch3, ch4) }
}
