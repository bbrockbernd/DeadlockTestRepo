...
- mutexes 
*/
package org.example.altered.test985
import org.example.altered.test985.RunChecker985.Companion.pool
...
class DeadlockExample {
    ...
    fun exampleFunction() = runBlocking(pool) {
        val job = launch(pool) {
            coroutineFunction()
        }
...
class RunChecker985: RunCheckerBase() {
    companion object {
