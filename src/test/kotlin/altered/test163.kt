...
import org.example.altered.test163.RunChecker163.Companion.pool
...
fun main(): Unit{
    ...
    runBlocking(pool) {
        ...
        launch(pool) { intermediate.filterAndForward() }
        launch(pool) { printer.print() }
        launch(pool) { summarizer.summarize() }
    }
}
