...
import org.example.altered.test301.RunChecker301.Companion.pool
...
fun main(): Unit= runBlocking(pool) {
    ...
    launch(pool) { coroutineB(channel3, channel4) }
    launch(pool) { coroutineC(channel5, channel6, channel7, channel8) }
