...
import org.example.altered.test185.RunChecker185.Companion.pool
...
fun main(): Unit{
    ...
    runBlocking(pool) {
        launch(pool) { function5(classA, classB) }
        launch(pool) { function6(classA, classC) }
        launch(pool) { function7(classD) }
    }
}
