...
import org.example.altered.test869.RunChecker869.Companion.pool
...
fun function2(classB: ClassB, classA: ClassA) = runBlocking(pool) {
    launch(pool) {
...
fun function3(classC: ClassC, classB: ClassB) = runBlocking(pool) {
    launch(pool) {
