...
- mutexes 
*/
package org.example.altered.test307
import org.example.altered.test307.RunChecker307.Companion.pool
...
fun main(): Unit= runBlocking(pool) {
    ...
    launch(pool) { function1(channel1, channel2, channel3) }
    launch(pool) { function2(channel4, channel5) }
    launch(pool) { function3(channel6) }
    launch(pool) { function4(channel1, channel2, channel3, channel4, channel5, channel6, channel7) }
...
class RunChecker307: RunCheckerBase() {
    companion object {
