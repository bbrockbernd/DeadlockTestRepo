...
- mutexes 
*/
package org.example.altered.test315
import org.example.altered.test315.RunChecker315.Companion.pool
...
fun main(): Unit = runBlocking(pool) {
    ...
    launch(pool) { executeProducer(producer) }
...
class RunChecker315: RunCheckerBase() {
    companion object {
