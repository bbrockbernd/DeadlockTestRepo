...
- mutexes 
*/
package org.example.altered.test791
import org.example.altered.test791.RunChecker791.Companion.pool
...
class DeadlockTest {
    ...
    fun createDeadlock() = runBlocking(pool) {
...
class RunChecker791: RunCheckerBase() {
    companion object {
