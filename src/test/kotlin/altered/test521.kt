...
- mutexes 
*/
package org.example.altered.test521
import org.example.altered.test521.RunChecker521.Companion.pool
...
fun main(): Unit= runBlocking(pool) {
    ...
    val job1 = launch(pool) { functionOne(channel) }
    val job2 = launch(pool) { functionTwo(channel) }
    val job3 = launch(pool) { functionThree(channel) }
