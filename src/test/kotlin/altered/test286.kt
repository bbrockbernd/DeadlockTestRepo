...
import org.example.altered.test286.RunChecker286.Companion.pool
...
fun functionOne(classA: ClassA, classB: ClassB) = runBlocking(pool) {
    launch(pool) {
...
fun functionTwo(classC: ClassC, classD: ClassD) = runBlocking(pool) {
    launch(pool) {
